...
export const cliArguments: CliParam[] = [
  {
    ...
    menuDescription: 'Initial prompt to send to andji',
  },
]
...
export const cliOptions: CliParam[] = [
  {
    ...
    menuDetails: [
      ...
      'See all: https://github.com/andjiAI/andji-community',
    ],
  },
  {
    flags: '--init',
    description:
      'Initialize andji on this project for a smoother experience',
    menuDescription: 'Initialize andji for the project',
  },
  {
  ...
  },
  {
    flags: '--model <model>',
    description:
      'Experimental: Specify the main model to use for the agent ("sonnet-3.6", "sonnet-3.7", "gpt-4.1", "gemini-2.5-pro", "o4-mini", "o3"). Be aware andji might not work as well with non-default models.',
